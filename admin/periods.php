...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create_period'])) {
    ...
    if ($year >= date('Y') && $month >= 1 && $month <= 12) {
        if (createTimePeriod($user_id, $year, $month, $db)) {
            // AUTO-ACTIVATE: Newly created period becomes active automatically
            autoActivateRecentPeriod($db);
            $message = "Time period created and activated successfully!";
        } else {
                            ...
                            <div class="card-body">
                                <form method="POST">
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" name="create_period" class="btn btn-primary">
                                            <i class="fas fa-calendar-plus me-2"></i>Create & Auto-Activate
                                        </button>
                                    </div>
                                </form>
                                ...
                                <div class="mt-3 p-3 bg-light rounded">
                                    <small class="text-muted">
                                        ...
                                        New periods are automatically activated. Previous periods remain available but inactive.
                                    </small>
                                </div>
                            </div>
                        </div>
